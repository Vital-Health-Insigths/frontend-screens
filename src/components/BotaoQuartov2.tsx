...
export default function BotaoQuartov2({ vagas_disp, vagas_total, numero, selected, onClick, setPagina }: BotaoQuartov2Props) {
  return (
    <button
        type="button"
        onClick={onClick}
        className={`
            relative w-[430px] rounded-[30px] border-[4px] border-[#046da0] bg-gradient-to-b from-[#ceeae8] to-[#c0eeeb]
        ...
        <div className={`text-right px-6 pb-1 overflow-hidden transition-all duration-350 ease-in-out items-center
            ...
            <button
                className="relative bottom-7 px-[25px] py-[15px] text-[20px] font-semibold text-white bg-[#0a6fa1] border-[4px] border-[#008479] 
                ...
                onClick={() => setPagina && setPagina("Home")}
                >
                ENTRAR
            </button>
