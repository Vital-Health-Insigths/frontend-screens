...
export default function Biometria({ setPagina }: Props) {
  return (
        ...
        <div className="relative w-[727px] h-[883px] bg-[#f5f5f5] border-[10px] border-white rounded-[40px] shadow-[15px_15px_15px_rgba(0,0,0,0.4)] overflow-hidden mx-auto">
            ...
            <div className="absolute flex flex-col items-center justify-center inset-0 gap-6 bottom-150 z-10 pointer-events-none">
                <h2 className="text-3xl font-semibold text-center text-black">
                    Posicione Seu Rosto No <br/> Centro Da Camera!
                </h2>
            </div>

            <div className="absolute flex flex-col items-center justify-center inset-0 bottom-[40px] z-10 pointer-events-none">
                <img 
                    src='/CSS/imagens/elementos/grid.png'
                    className='relative w-[400px] h-[400px] object-contain block z-0 '
                />
            </div>
